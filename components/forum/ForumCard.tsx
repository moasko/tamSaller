...
import { BiLinkAlt, BiTimeFive, BiTimer } from 'react-icons/bi'
        ...
        <article className='bg-white rounded-md p-3 flex space-x-4'>
            ...
            <div className='w-full space-y-4'>
                ...
                <div className='flex w-full justify-between items-center '>
                    ...
                    <div className='text-xs flex items-center space-x-2'> <BiTimeFive size={15} color='#CACACA' />
                        <span>il y a 12 min</span>
                    </div>
                </div>
                <p>Je suis a la recherche une montres Quamer de couleur rouge original et je suis a koumassi grand marché montres Quamer de couleur rouge montres Quamer de couleur rouge</p>
                <div className='w-full flex justify-between items-center'>
                    ...
                    <div className='flex space-x-3 item-center'>
                        <h2 className='text-sm'>Budjet : <span className='font-semibold'>25 0000 FCFA</span></h2>
                        <div className=' bg-rose-100 text-red-600 px-3 py-1 rounded-md text-xs flex items-center space-x-2'> <BiTimer size={16} /> <span>Expire dans 6 Heures</span></div>
